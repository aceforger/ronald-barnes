...
//         <div
//           className="absolute top-1/2 right-0 -translate-y-1/2 w-[450px] h-[450px] border border-[#1E4E79]/5 rounded-full animate-subtle-rotate pointer-events-none"
...
//                   <p className="text-[10px] font-roboto-slab text-[#1E4E79]/50 uppercase tracking-wider">
//                     Books Written
//                   </p>
//                 </div>
//                 <div className="bg-white/60 backdrop-blur-sm rounded-2xl px-4 py-3 text-center border border-[#1E4E79]/10">
...
//                 </div>
//                 <div className="bg-white/60 backdrop-blur-sm rounded-2xl px-4 py-3 text-center border border-[#1E4E79]/10">
//                   <p className="text-2xl font-dm-serif text-[#C9A227]">
//                     2,500+{" "}
//                   </p>
//                   <p className="text-[10px] font-roboto-slab text-[#1E4E79]/50 uppercase tracking-wider">
//                     Pages
...
//                 "Where one person sees a skeptical impossibility, another sees a
...
//                   <span
//                     key={i}
//                     className="px-4 py-2 bg-white/60 backdrop-blur-sm text-[#1E4E79] text-sm font-roboto-slab font-medium border border-[#1E4E79]/15 hover:border-[#C9A227]/40 hover:text-[#C9A227] hover-lift transition-all rounded-full"
//                   >
//                     {role}
//                   </span>
//                 ))}
...
//                   className="px-8 py-4 bg-[#C9A227] text-white font-roboto-slab font-semibold hover:bg-[#B08F1E] transition-all text-center hover-lift rounded-full shadow-[0_0_25px_rgba(201,162,39,0.2)]"
//                 >
//                   About the Author
//                 </a>
//                 <a
...
//                   className="px-8 py-4 border-2 border-[#C9A227]/30 text-[#1E4E79] font-roboto-slab font-semibold hover:border-[#C9A227] hover:text-[#C9A227] transition-all text-center hover-lift rounded-full"
//                 >
//                   View All Books
//                 </a>
//               </div>
...
//             Dr. Ronald Barnes shares his insights on psychology, faith, and the
//             human experience
//           </p>
      ...
      <div className="min-h-screen flex items-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 md:py-32 w-full">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            {/* Right - Profile Image Blended */}
            <div className="flex-shrink-0 animate-fade-up-delayed flex justify-center">
              <div className="relative">
                {/* Soft glow behind the person */}
                <div className="absolute -inset-8 bg-[#C9A227]/6 rounded-full blur-3xl animate-eye-pulse pointer-events-none"></div>

                {/* Profile image - no card, no border, no shadow, soft bottom fade */}
                <div className="relative w-72 md:w-80 lg:w-96">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      fallback.innerHTML = `
            <span class="text-7xl font-cinzel red-gradient-text font-bold">JC</span>
            <div class="w-14 h-[2px] bg-gradient-to-r from-[#C41E3A] to-[#E84057] mx-auto mt-4"></div>
          `;
