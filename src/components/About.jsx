...
//                   </svg>
//                 </div>
//                 <span className="text-xs font-roboto-slab font-bold text-[#C9A227] tracking-wider uppercase">Early Life & Education</span>
//               </div>
//               <p className="text-[#1E4E79]/60 leading-relaxed font-roboto-slab">{authorInfo.bio}</p>
//             </div>

//             {/* Bio 2 - Academic Journey & Philosophy */}
...
//                   </svg>
//                 </div>
//                 <span className="text-xs font-roboto-slab font-bold text-[#C9A227] tracking-wider uppercase">Academic Journey & Philosophy</span>
//               </div>
//               <p className="text-[#1E4E79]/60 leading-relaxed font-roboto-slab">{authorInfo.bio2}</p>
//             </div>
    ...
    <section id="about" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16 animate-fade-up">
          ...
          <h2 className="text-Sxl md:text-6xl font-dm-serif font-bold text-[#1E4E79] mb-4">
            {authorInfo.name}
          </h2>
          <div className="w-20 h-[2px] bg-gradient-to-r from-[#C9A227] to-[#1E4E79] mx-auto mt-6"></div>
          ...
          <button
            ...
            className="inline-flex items-center gap-2 mt-6 px-6 py-3 bg-[#1E4E79] text-white font-roboto-slab font-semibold text-sm rounded-full hover:bg-[#153A5C] transition-all shadow-lg hover:shadow-xl animate-pulse"
          >
            <svg
              className="w-4 h-4"
              fill="none"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-[#1E4E79] to-[#153A5C] rounded-3xl p-8 md:p-10 text-center mb-12 animate-fade-up shadow-lg">
            <svg
              className="w-8 h-8 text-white/30 mx-auto mb-4"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
              <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
          ...
          <div className="space-y-6 mb-6">
            <div className="bg-[#F8F7F2] p-8 rounded-2xl border border-[#1E4E79]/8 hover-lift animate-fade-up">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xs font-roboto-slab font-bold text-[#C9A227] tracking-wider uppercase">
                  Early Life & Education
                </span>
              </div>
              <p className="text-[#1E4E79]/60 leading-relaxed font-roboto-slab">
                {authorInfo.bio}
              </p>
            </div>
          ...
          <div className="flex flex-wrap gap-3 justify-center mt-10">
            {authorInfo.roles.map((role, i) => (
              <span
                key={i}
                className="px-6 py-3 bg-white text-[#1E4E79] text-sm font-roboto-slab font-medium border border-[#1E4E79]/15 hover:border-[#C9A227]/40 hover:text-[#C9A227] hover-lift transition-all rounded-2xl shadow-sm"
              >
                {role}
              </span>
            ))}
          ...
          {/* Tribute Section - keep as is */}
          <div className="mt-16 animate-fade-up">
            <div className="bg-gradient-to-br from-[#1E4E79] to-[#153A5C] rounded-3xl p-8 md:p-10 shadow-lg">
              {/* ... rest of tribute content ... */}
            </div>
          </div>
        </div>
      </div>
        ...
        {showCV && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-2xl w-full max-w-8xl max-h-[100vh] overflow-hidden"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Header */}
              <div className="flex items-center justify-between p-6 border-b border-gray-200">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#1E4E79] rounded-lg flex items-center justify-center">
                    <svg
                  ...
                  <div>
                    <h3 className="text-lg font-dm-serif text-[#1E4E79]">
                      Curriculum Vitae
                    </h3>
                    <p className="text-xs text-gray-400 font-roboto-slab">
                      {authorInfo.name}
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  {/* Open in Google Docs */}
                  <a
                    href="https://docs.google.com/document/d/1JzMPn4OCFKWTxvNWbm4oSn3smNm3OQxdU79-L5z6QAE/edit?usp=sharing"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-4 py-2 bg-[#C9A227] text-white text-xs font-roboto-slab font-bold rounded-full hover:bg-[#B08F1E] transition-all"
                  >
                    <svg
                      className="w-4 h-4"
                      fill="none"
              ...
              >
                <iframe
                  src="https://docs.google.com/document/d/1JzMPn4OCFKWTxvNWbm4oSn3smNm3OQxdU79-L5z6QAE/preview"
